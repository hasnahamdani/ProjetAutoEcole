            ...
            <?php foreach ($candidats as $candidat): ?>
                <div class="card">
                    ...
                    <a href="#" class="icon-info" onclick="showDetails(<?= $candidat['id'] ?>)">
                        ...
                        <div class="popup-name"><strong><?= esc($candidat['tele']) ?></strong></div>
        ...
        <div class="form first">
            ...
            <div class="details ID">
                ...
                <div class="fields" id="moniteur_pratique_info">
                    <div class="input-field">
                        <label for="nom_moniteur_pratique">Nom  de moniteur pratique:</label>
                ...
                <div class="fields" id="moniteur_theorique_info">
                    <div class="input-field">
                        <label for="nom_moniteur_theorique">Nom de moniteur théorique:</label>
